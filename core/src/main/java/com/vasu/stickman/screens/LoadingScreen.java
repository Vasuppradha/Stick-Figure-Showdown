...
public class LoadingScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        game.shapeRenderer.rect(viewport.getWorldWidth() / 2f - PROGRESS_BAR_MAX_WIDTH / 2f, viewport.getWorldHeight() /
            2f - PROGRESS_BAR_HEIGHT / 2f, game.assets.manager.getProgress() * PROGRESS_BAR_MAX_WIDTH, PROGRESS_BAR_HEIGHT);
