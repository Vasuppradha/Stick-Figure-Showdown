...
public class SettingsScreen implements Screen {
    ...
    private void addButtonListeners(){
        ...
        //add the toggle button listener
        musicToggleButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                //if the music setting is on, enable music; otherwise, diable it
        ...
        //add the sounds button listener
        soundsToggleButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                //if the sounds setting is on, enable sounds; otherwise, disable it
    ...
    private void createTables(){
        ...
        //create the difficulty image stack and the difficulty images to it
        ...
        //create the blood screen table and set its background to the blood screen setting background image
    ...
    public void render(float delta) {
        ...
        //tell the stage to do the actions and draw itself
        stage.act(delta);
        stage.draw();
    }
