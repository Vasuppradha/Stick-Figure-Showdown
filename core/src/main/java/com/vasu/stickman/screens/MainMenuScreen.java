...
public class MainMenuScreen implements Screen{
    ...
    public MainMenuScreen(SFS game){
        ...
        //get the menu atlas texture atlas from the asset manager
    ...
    private void createTables(){
        ...
        //add the logo to the left side table and start a new row
        ...
        //add the play game, settings and quiot game button to the right side table
